...
class VacanciesController < ApplicationController
  ...
  def archive
    ...
    if @vacancy.archive!
      ...
      redirect_to vacancies_path, alert: "Vacancy couldn't be archived!"
    end
  end
  ...
  def publish
    ...
    if @vacancy.archived?
      redirect_to vacancies_path, alert: 'Cannot publish archived vacancy.s'
      return
    end
    ...
    if @vacancy.publish!
      ...
      redirect_to vacancies_path, alert: "Vacancy couldn't be published!"
    end
  end
  # END
