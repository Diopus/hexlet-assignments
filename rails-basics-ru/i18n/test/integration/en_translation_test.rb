...
class EnTranslationTest < ActionDispatch::IntegrationTest
  ...
  test 'posts#create successfully' do
    ...
    assert_select '.alert-info', 'Post was succesfully created'
  end
  ...
  test 'posts#update' do
    ...
    assert_select '.alert-info', 'Post was succesfully updated'
  end
  ...
  test 'posts#destroy' do
    ...
    assert_select '.alert-info', 'Post was succesfully destroyed'
  end
  ...
  test 'comment#create' do
    ...
    assert_select '.alert-info', 'Comment was succesfully created'
  end
  ...
  test 'comment#update' do
    ...
    assert_select '.alert-info', 'Comment was succesfully updated'
  end
end
